...
function CropSelection() {
  ...
  const handleGetRecommendations = () => {
      axios.post("http://127.0.0.1:8000/recommendation/",{
        ...
        "K":potassium,
        "PH":5
      }).then((res)=>setRecommendations(Object.values(res.data.data))).catch((e)=>console.log(e))
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {recommendations.map((crop, i) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-gray-800 mb-3">{crop['crop']}</h3>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Soil Type:</span>
                      <span className="font-semibold text-gray-800">{crop['soil_type']}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-green-600">{crop['expected_yield']}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Water Requirement:</span>
                      <span className="font-semibold text-blue-600">{crop['water_requirement']}</span>
                    </div>
                    <div className="border-t border-gray-200 mt-3 pt-3">
                      <div className="text-xs text-gray-600 font-semibold mb-2">NPK Requirements (kg/ha):</div>
                      <div className="flex justify-between text-xs">
                        <span className="text-gray-600">N:null</span>
                        <span className="text-gray-600">P:null</span>
                        <span className="text-gray-600">K:null</span>
                      </div>
                    </div>
                  </div>
                </div>
